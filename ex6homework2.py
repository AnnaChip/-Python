...
class Road:
    ...
    def weight(self):
        number_sm = float(input('Введите желаемую толщину полотна в сантиметрах: '))
        result = self._length * self._width * 25 * number_sm
        return result

my_road = Road(20, 50)
print(f'Масса асфальта при заданных параметрах составит {my_road.weight()} тонн')
