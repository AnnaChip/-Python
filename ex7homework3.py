...
# Вычитание. Участвуют две клетки. Операцию необходимо выполнять только если разность количества ячеек двух клеток б
# ольше нуля, иначе выводить соответствующее сообщение.
...
class Cell:
    ...
    def __sub__(self, other):
        ...
        return f'{sub}' if sub > 0 else 'разность меньше нуля'
